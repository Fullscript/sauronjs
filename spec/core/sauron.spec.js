var sauron = require('core/sauron');
var insert = sauron.insert;
var Component = sauron.Component;
...
describe('the eye of sauron', function() {
  ...
  it('bootstraps the page', function() {
    ...
    var app = sauron.instance({foo: Foo});
  ...
  it('tracks components with no associated constructor', function() {
    ...
    var app = sauron.instance({bar: Foo});
